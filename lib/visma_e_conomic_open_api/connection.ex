...
defmodule VismaEConomicOpenAPI.Connection do
  @moduledoc """
  Handle Tesla connections for VismaEConomicOpenAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, VismaEConomicOpenAPI.Connection,
        base_url: "https://apis.e-conomic.com/api/v16.2.1",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :visma_e_conomic_open_api,
        :base_url, "https://apis.e-conomic.com/api/v16.2.1"
  """

  @default_base_url Application.compile_env(
                      :visma_e_conomic_open_api,
                      :base_url,
                      "https://apis.e-conomic.com/api/v16.2.1"
                    )
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:visma_e_conomic_open_api, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - VismaEConomicOpenAPI v16.2.1 - elixir"
        )
      )
